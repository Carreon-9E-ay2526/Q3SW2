    ...
    document.getElementById("Storeloc").innerHTML = `
        <div class="container bg-secondary">
                    ...
                    <p>
                        ...
                        Manila City: SM San Lazaro! We're excited to be located on the 3/F CYBERZONE SM SAN LAZARO, FELIX HUERTAS STREET CORNER LACSON AVENUE (C-2 ROAD), SANTA CRUZ<br>
                    </p>
        </div>
    `
}